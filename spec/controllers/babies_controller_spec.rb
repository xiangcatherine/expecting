...
RSpec.describe BabiesController, type: :controller do
  ...
  # Baby. As you add validations to Baby, be sure to
  ...
  # BabiesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all babies as @babies" do
      ...
      expect(assigns(:babies)).to eq([baby])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested baby as @baby" do
      ...
      expect(assigns(:baby)).to eq(baby)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new baby as @baby" do
      ...
      expect(assigns(:baby)).to be_a_new(Baby)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created baby as @baby" do
        post :create, params: {baby: valid_attributes}, session: valid_session
        expect(assigns(:baby)).to be_a(Baby)
        expect(assigns(:baby)).to be_persisted
      end
